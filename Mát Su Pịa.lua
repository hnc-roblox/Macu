...
_G.NameHub = "by tuananhiosdz" -- ชื่อ Hub
_G.Title = "Tuấn Anh IOS" -- คำอธิบาย
-----------------------------------------------------------------
	...
	coroutine.resume(
		coroutine.create(
			function()
				...
				Circle.BackgroundTransparency = 0.000
				Circle.ZIndex = 10
...
function library:NaJa()
	...
	ClickFrame.BackgroundTransparency = 0
...
Discord.BackgroundTransparency = 0 -- Làm cho nền trong suốt
...
Disc_Logo.BackgroundTransparency = 0.000
...
Disc_Title.BackgroundTransparency = 0.000
...
Discord.MouseLeave:Connect(function()
    TweenObject(Discord, {BackgroundTransparency = 0}, .15)
...
UICorner.Parent = ImageButton
	...
	function tabs:Tab(Name, icon)
		...
		FrameTab.BackgroundTransparency = 0.4
		...
		Page.BackgroundTransparency = 0.000
		...
		function sections:Section(Name,side)
			...
			Top_2.BackgroundTransparency = 0.000
			...
			Sectionname.BackgroundTransparency = 0.000
			...
			SectionContainer.BackgroundTransparency = 0.000
			...
			SectionContainer_2.BackgroundTransparency = 0.000
			...
			function functionitem:Label(text)
				...
				Label.BackgroundTransparency = 0.000
				...
				Text.BackgroundTransparency = 0.000
			...
			function functionitem:Button(Title, default, callback)
				...
				TextLabel_4.BackgroundTransparency = 0.000
				...
				TextButton_4.BackgroundTransparency = 0.000
     ...
     function functionitem:Seperator(text)
	   ...
	   Seperator.BackgroundTransparency = 0.000
	   Seperator.Size = UDim2.new(0.975, 0, 0, 20)

	   Sep2.Name = "Sep2"
	   Sep2.Parent = Seperator
	   Sep2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	   Sep2.BackgroundTransparency = 0.000
	   ...
	   Sep2.TextXAlignment = Enum.TextXAlignment.Center
		...
		function functionitem:Button(Name, callback)
				...
				TextLabel_3.BackgroundTransparency = 0.000
			...
			function functionitem:Textbox(Name, Placeholder, callback)
				...
				Text_5.BackgroundTransparency = 0.000
				...
				TextboxHoler.BackgroundTransparency = 0.000
			...
			function functionitem:Dropdown(Name, list, default, callback)
				...
				v.BackgroundTransparency = 0.000
				v.BorderSizePixel = 0
				...
				Text_2.BackgroundTransparency = 0.000
				...
				ImageButton.BackgroundTransparency = 0.000
				...
				Scroll_Items.BackgroundTransparency = 0.000
  ...
  function functionitem:Slider(text, floor, min, max, de, callback)
    ...
    LabelNameSlider.BackgroundTransparency = 0.000
    ...
    PartValue.BackgroundTransparency = 0.0  -- Full transparency
